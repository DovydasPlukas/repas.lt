  ...
  if (isLoading) {
    return (
      <Card className="w-full max-w-md mx-auto">
        <CardHeader>
          <p className="text-2xl font-semibold text-center">Asmeninė informacija</p>
        </CardHeader>
        <CardContent>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div className="flex items-stretch rounded-lg border border-gray-300 bg-white overflow-hidden">
                      <span className="px-3 py-2 font-medium text-gray-700 flex items-center">+370</span>
                      <input
                        {...field}
                        disabled={isPending}
                        ...
                        maxLength={8}
                        className="flex-1 border-0 px-3 py-2 focus:outline-none min-w-0"
                      />
                    </div>
                  </FormControl>
                  <FormMessage />
